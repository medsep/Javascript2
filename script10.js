...
function runTheExample() {
    ...
    document.getElementById('second').innerHTML = "See how I set the etxt here?";
    
   var listOfParas = document.getElementsByTagName('p');
   //alert(listOfParas.length)

   var secPara = listOfParas[1];
   alert(secPara.innerHTML);
   ...
   //anchor.href = "http://www.bbc.co.uk/news";
   anchor.setAttribute('href', 'http://www.bbc.co.uk')*/
